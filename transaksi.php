...
<ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <li class="treeview">
          <a href="kategori.php">
            <i class="glyphicon glyphicon-tasks"></i> <span>Kategori</span>
          </a>
        </li>

        <li class="treeview">
          <a href="kategori.php">
            <i class="glyphicon glyphicon-share"></i> <span>Barang Keluar</span>
          </a>
        </li>
    ...
    <section class="content">
            ...
            <form role="form" method="post" action="#" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <input type="text" name="nama_kategori" class="form-control" id="exampleInputEmail1" placeholder="Nama Kategori" required="required">
                </div>
              </div>
              <!-- /.box-body -->
       ...
       <div class="col-md-6">
          ...
          <div class="box">
            ...
            <td> 
               <a href='hapusKategori.php?id_kategori=".$row['id_kategori']." type='button' class='btn btn-danger'><i class='fa fa-eraser'></i></a>
            </td>
             </tr>";
